(function(global) {
  class ndvpainter extends NIN.THREENode {constructor(id) {
      ...
      this.n_channel = '#FF0000';
      this.dv_channel = '#00FF00';
      this.bg_channel = '#0000FF';
    }
    ...
    render() {
      ...
      this.ctx.fillStyle = this.bg_channel;
      ...
      this.ctx.fillStyle = this.n_channel;
      ...
      this.ctx.fillStyle = this.dv_channel;
